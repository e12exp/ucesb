...
#define EXT_STR_ITEM_INFO_ALL(ok,struct_info,struct_t,printerr,		\
			      item,type,name,ctrl,limit_max)		\
  if (!printerr) {							\
    ok &= (ext_data_struct_info_item(struct_info,			\
				     offsetof (struct_t, item),		\
...
#define EXT_STR_ITEM_INFO(ok,struct_info,struct_t,printerr,		\
			  item,type,name)				\
  EXT_STR_ITEM_INFO_ALL(ok,struct_info,struct_t,printerr,		\
			item,type,name,"",-1)

#define EXT_STR_ITEM_INFO_ZZP(ok,struct_info,struct_t,printerr,		\
			      item,type,name,ctrl)			\
  EXT_STR_ITEM_INFO_ALL(ok,struct_info,struct_t,printerr,		\
			item,type,name,ctrl,-1)

#define EXT_STR_ITEM_INFO_LIM(ok,struct_info,struct_t,printerr,		\
